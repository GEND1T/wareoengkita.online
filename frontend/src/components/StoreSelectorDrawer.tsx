          ...
          {filteredStores.length === 0 ? (
            ...
            filteredStores.map((st) => {
              ...
              return (
                <div
                  key={st.id}
                  className={`bg-white rounded-3xl overflow-hidden border transition-all duration-200 flex flex-col justify-between shadow-xs ${
                    isSelected
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="pt-2 flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`flex-1 font-extrabold py-3 px-4 rounded-2xl text-xs transition-all flex items-center justify-center gap-2 active:scale-98 ${
                          isSelected
