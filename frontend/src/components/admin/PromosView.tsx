          ...
          promos.map((banner) => (
            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden bg-gray-100">
                ...
                <span
                  className={`absolute top-3 right-3 text-[10px] font-black px-2.5 py-1 rounded-full shadow-lg ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-5 space-y-3">
                  ...
                  <div
                    ...
                    onDrop={handleDrop}
                    className={`relative rounded-2xl border-2 border-dashed p-4 flex flex-col items-center justify-center text-center transition-all min-h-[200px] ${
                      dragActive
