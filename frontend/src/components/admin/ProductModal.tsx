              ...
              <div className="md:col-span-5 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[0, 1, 2].map((slotIdx) => {
                    ...
                    return (
                      <div
                        key={slotIdx}
                        className={`relative aspect-square rounded-xl border-2 overflow-hidden flex flex-col items-center justify-center bg-gray-50 transition-all ${
                          imgUrl ? 'border-emerald-500' : 'border-dashed border-gray-300 hover:border-[#063104]'
                        }`}
                      >
                        {imgUrl ? (
                ...
                {images.length === 0 && (
                  <div
                    ...
                    onDrop={handleDrop}
                    className={`relative rounded-2xl border-2 border-dashed p-4 flex flex-col items-center justify-center text-center transition-all min-h-[140px] ${
                      dragActive
