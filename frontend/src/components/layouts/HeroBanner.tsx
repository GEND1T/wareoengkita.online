      ...
      >
        ...
        {slides.map((slide, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`absolute inset-0 p-5 sm:p-7 md:p-8 flex items-center justify-between transition-all duration-700 ease-in-out ${isActive
        ...
        <div className="absolute bottom-2.5 left-1/2 -translate-x-1/2 flex items-center gap-1.5 z-20">
          {slides.map((_, idx) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 focus:outline-none ${activeSlide === idx
                ? 'w-5 bg-white'
