          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`p-4 rounded-2xl flex flex-col items-center justify-center text-center gap-2 border transition-all duration-200 focus:outline-none ${isSelected
              ...
              >
                <div
                  className={`p-2.5 rounded-full ${isSelected ? 'bg-white/10 text-white' : 'bg-emerald-50 text-[#77a160]'
                    }`}
                >
                ...
                <div>
                  ...
                  {cat.count !== undefined && (
                    <span
                      className={`text-[11px] ${isSelected ? 'text-emerald-200' : 'text-gray-400'
                        }`}
                    >
                      {cat.count} produk
                    </span>
