                    ...
                    {methodsInCat.map((m) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-3.5 rounded-2xl border transition-all text-left flex items-center justify-between gap-3 group relative ${isSelected
                        ...
                        >
                          ...
                          <div className={`w-5 h-5 rounded-full border flex items-center justify-center shrink-0 transition-colors ${isSelected ? 'border-[#063104] bg-[#063104]' : 'border-slate-300'
                            }`}>
