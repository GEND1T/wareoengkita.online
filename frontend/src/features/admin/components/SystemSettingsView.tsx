...
import { FormSkeleton } from '../../../components/common/AdminSkeletons';
          ...
          <div className="flex items-center justify-between pb-3 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${announcementActive ? 'bg-[#063104]' : 'bg-gray-300'
                  }`}
              >
                <span
                  className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-md ring-0 transition duration-200 ease-in-out ${announcementActive ? 'translate-x-5' : 'translate-x-0'
                    }`}
                />
              </button>
            </div>
